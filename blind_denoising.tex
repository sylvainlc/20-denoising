...
Remarkably, our method performs significantly better than the supervised method CARE \cite{weigert2017content}, with an average PSNR increase of $+1.49$dB\footnote{Comparison with PSNR values reported in \cite{goncharova2020}}.
...
\section{Code}
Source code as well as a notebook to reproduce the results will be made available after the reviewing process.
