...
For the observed noise and 3 types of synthetic noises, let $X$ be the ground truth and $Y$ the noisy observations (displayed in column ).
The plots display the observed standard deviation of the noise $Y - X$, as well as the predicted standard deviation of the noise by NNet.
