...
The blind denoising framework introduced in this paper can be written as a regression problem where the observations conditionally on the neighborhood $\Omega_Y$ of $Y$ the observation is given by
$$
...
%Y = \mu_{\theta_p}(\Omega_Y;\overline{\Omega_Y}) + \sigma_{\theta_n}(\mu_{\theta_p}(\Omega_Y;\overline{\Omega_Y}))\varepsilon\,,
%$$
where $\varepsilon$ is centered noise and $\overline{\Omega_Y}$ is the empirical mean of $\Omega_Y$. 
