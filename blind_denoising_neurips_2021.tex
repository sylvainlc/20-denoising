...
\times \left.\exp\left\{-\frac{1}{2}\left(\frac{Y_i-\mu_{\theta_d}(\Omega_{Y_i},g(\Omega_{Y_i}))-  \mu_{k,\theta_n}(\mu_{\theta_d}(\Omega_{Y_i},g(\Omega_{Y_i})))}{\sigma_{k,\theta_n}(\mu_{\theta_d}(\Omega_{Y_i},g(\Omega_{Y_i}))}\right)^2\right\}\right)\,.
...
In this paper, we introduce Noise2Same, a self-supervised framework for deep image denoising. As
