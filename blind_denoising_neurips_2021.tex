...
\vskip -0.2in
\end{figure}
\footnotetext{Display range was shrinked in Y-axis for visualization purposes, excluding some points of the empirical standard deviation of the Speckle noise model.}
...
Metrics computed on noisy images are displayed in the \textit{Noisy} columns. For DecoNoising (\textit{DN}) and N2V, PSNR are taken from \cite{goncharova2020} and SSIM are computed on prediction made by networks trained using the source code provided by the authors (using no positivity constraint, and removing the convolution for N2V). \textit{Gaussian} corresponds to the optimal Gaussian baseline defined in section~\ref{sec:perf}. \textit{Supervised} corresponds to supervised training of DNet trained with L2 objective. For each dataset the best of our method predicting a Gaussian model, a 2 or 3-component-GMM is shown (see Table~\ref{si:table:nnet} for details).}
\label{table:results}
\vskip -0.15in
\begin{center}
\begin{small}
...
\toprule
Dataset & Noisy & Gaussian & Supervised & N2V & DN & Ours (best) \\
\midrule
PN2V-C & $28.98$ / $0.7713$ & $34.92$ / $0.9409$ & $NA$ / $NA$ & $35.85$ / $0.9404$ & $36.39$ / $0.9483$ & $\underline{38.47}$ / $\underline{0.9738}$ \\
PN2V-MN & $28.10$ / $0.6836$ & $35.53$ / $0.9392$ & $NA$ / $NA$ & $35.86$ / $0.9419$ & $36.34$ / $0.9489$ & $\underline{39.22}$ / $\underline{0.9779}$\\
...
W2S-2 & $19.33$ / $0.2256$ & $32.27$ / $0.8531$ & $33.24$ / $0.8828$ & $31.80$ / $0.8311$ & $32.31$ / $0.8524$ & $\underline{33.48}$ / $\underline{0.8871}$\\
W2S-3 & $20.39$ / $0.2232$ & $34.66$ / $0.9013$ & $36.31$ / $0.9252$ & $34.65$ / $0.8637$ & $35.09$ / $0.9051$ & $\underline{36.60}$ / $\underline{0.9269}$\\
\bottomrule
\end{tabular}
}
\end{sc}
...
% parler de
% - performances supérieures a supervised.
% - limite: ne fonctionne pas sur bruit structuré (seulement axial)
% - 
...
\subsection{Impact of NNet}
\begin{figure}[ht]
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{fig_convergence_1col.pdf}}
\caption{PSNR at each epoch on the test set for N-net (G1) or D-net only (L2). A: training on real noise; final performance gain of G1 over L2 is $+0.11dB$. B, C: training on different models/levels of synthetic noise added to ground truth image. C: \textit{Gaussian} and \textit{Speckle} correspond to noises presented in 5.1, that have no and high signal dependency respectively. D: \textit{Speckle} with variance multiplied by 0.5, 2 and 4. D: Mean and SEM over 5 runs.}
\end{center}
\vskip -0.2in
\end{figure}

\begin{table}[ht]
\caption{Impact of NNet on performances. Comparison between our method predicting a GMM with 1, 2, or 3 components (respectively G1, G2, G3) and DNet only trained with L2 loss.}
\label{si:table:nnet}
\vskip -0.15in
\begin{center}
\begin{sc}
\begin{tabular}{l@{\hskip 7.5pt}c@{\hskip 7.5pt}c@{\hskip 7.5pt}c@{\hskip 7.5pt}c@{\hskip 7.5pt}c}
\toprule
Dataset & Noisy & L2 & Ours (G1) & Ours (G2) & Ours (G3) \\
\midrule
PN2V-C & $28.98$ / $0.7713$ & $37.41$ / $0.9638$ & $38.33$ / $\underline{0.9754}$ & $\underline{38.47}$ / $0.9738$ & $38.28$ / $\underline{0.9756}$ \\
PN2V-MN & $28.10$ / $0.6836$ & $37.67$ / $0.9670$ & $39.08$ / $\underline{0.9776}$ & $\underline{39.22}$ / $\underline{0.9779}$ & $\underline{39.18}$ / $\underline{0.9780}$ \\
PN2V-MA & $23.71$ / $0.3731$ & $34.44$ / $0.8842$ & $\underline{34.79}$ / $\underline{0.8905}$ & $34.68$ / $0.8880$ & $\underline{34.70}$ / $0.8877$ \\
W2S-1 & $21.85$ / $0.3490$ & $35.18$ / $0.9611$ & $\underline{35.33}$ / $\underline{0.9619}$ & $\underline{35.27}$ / $\underline{0.9623}$ & $\underline{35.27}$ / $\underline{0.9624}$ \\
W2S-2 & $19.33$ / $0.2256$ & $\underline{33.36}$ / $0.8831$ & $\underline{33.46}$ / $\underline{0.8867}$ & $\underline{33.48}$ / $\underline{0.8871}$ & $\underline{33.47}$ / $\underline{0.8871}$ \\
W2S-3 & $20.39$ / $0.2232$ & $36.42$ / $0.9234$ & $\underline{36.57}$ / $\underline{0.9263}$ & $\underline{36.60}$ / $\underline{0.9269}$ & $\underline{36.59}$ / $\underline{0.9269}$ \\
\bottomrule
\end{tabular}
\end{sc}
\end{center}
