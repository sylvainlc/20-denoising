...
Metrics computed on noisy images are displayed in the \textit{Noisy} columns.
...
\textit{Gaussian} corresponds to the optimal Gaussian baseline defined in section~\ref{sec:perf}. For each dataset the best of our method predicting a Gaussian model, a 2 or 3-component-GMM is shown (see Table~\ref{si:table:results} for details).}
\label{table:results}
\vskip -0.15in
\begin{center}
\begin{small}
...
\begin{enumerate}
  ...
  \item Did you describe the limitations of your work?
    \answerTODO{\ref{sec:discussion} (TODO should we explicitly say that it do not apply to centered / structured noises ? )}
...
\begin{enumerate}
  ...
  \item Did you mention the license of the assets?
    \answerNo{No licence was found along with the datasets, but they are made publicly available by the authors}
