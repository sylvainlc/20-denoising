...
The authors address co-learning of a simple noise model, by constraining noise variance to scale linearly with the signal, making the method fully self-supervised.
...
\toprule
Dataset & Noisy & Gaussian & Supervised & N2V & DecoNoising & Ours (best) \\
\midrule
