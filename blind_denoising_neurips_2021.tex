...
\begin{enumerate}
  ...
  \item Did you specify all the training details (e.g., data splits, hyperparameters, how they were chosen)?
    ...
    \answerYes{We only report error bars in a few cases (e.g. appendix \ref{si:impactnnet}-D). We believe our results are very stable, but did not run systematically the experiments multiple times due to computation limitation.}
