...
Note that datasets PN2V-C and PN2V-MA have horizontally-correlated noise (that we take into account: see Section~\ref{sec:datasets}), which significantly lower the performances of methods that are sensitive to it, such as FBI-Denoiser or N2V.
